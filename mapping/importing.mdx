---
title: "Import Maps from osu!, Quaver, and Stepmania"
sidebarTitle: "Importing"
description: "fluXis can import maps from osu! (.osz), Quaver (.qp), and Stepmania (.sm/.ssc) formats. Learn how to trigger an import and what gets converted."
---
