---
title: "The fluXis Map Editor: A Complete Overview"
sidebarTitle: "Editor Overview"
description: "The fluXis editor has four tabs — Setup, Charting, Design, and Verify. Learn the interface layout, keyboard shortcuts, snap settings, and how to save your work."
---

The fluXis map editor is the built-in tool for creating and editing maps directly inside the game. It is organized into four tabs that each handle a distinct phase of map creation: setting up metadata and assets, placing hit objects, designing visual events, and verifying map quality before upload. The editor loads asynchronously so the Charting and Design tabs show a spinner while their complex containers initialize — this is expected behavior, not a freeze.
...
<CardGroup cols={2}>
  ...
  <Card title="Verify" icon="check-square">
...
<Note>
  A fifth **Storyboard** tab exists in the source code for managing storyboard animations and is accessible once a storyboard is added to your map.
</Note>
