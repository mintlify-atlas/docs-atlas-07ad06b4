...
The final window is then divided by the current **rate multiplier** (if a Rate mod is active) — faster rates tighten the effective window, making timing harder.
...
accBased    = (ratedNotes / maxCombo) × (maxScore × 0.90)
comboBased  = (maxCombo / totalNotes) × (maxScore × 0.10)
