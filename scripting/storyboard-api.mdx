...
description: "The storyboard Lua API provides Add(), element constructors (Box, Sprite, Text, Circle, SkinSprite), and global objects for screen, metadata, and settings."
---
