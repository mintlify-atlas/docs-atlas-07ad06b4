...
description: "fluXis uses Lua scripts to drive storyboards and skins, with access to NLua runtime, audio analysis, easing functions, and visual element APIs."
---
