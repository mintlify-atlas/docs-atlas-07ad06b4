---
title: "Set Up Lua IDE and Language Server for fluXis Scripting"
sidebarTitle: "IDE Setup"
description: "Configure VS Code or Rider with the sumneko Lua language server and fluXis type definitions for autocomplete and type hints in storyboard scripts."
---
...
| `map.lua` | `map:NotesInRange()`, `map:TimingPointsInRange()`, `map:ScrollVelocitiesInRange()`, `map:EventsInRange()` |
